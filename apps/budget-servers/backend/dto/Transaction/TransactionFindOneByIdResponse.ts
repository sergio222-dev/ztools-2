...
const TransactionFindOneByIdResponseSchema = z.object({
...
export class TransactionFindOneByIdResponse extends createZodDto(TransactionFindOneByIdResponseSchema) {}
