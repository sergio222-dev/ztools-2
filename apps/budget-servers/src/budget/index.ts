...
import { MonthlyBudgetFindByMonthYearHandler } from '@budget/monthlyBudget/application/useCase/find/MonthlyBudgetFindByMonthYear.handler';
...
const budget = {
  ...
  handlers: [
    ...
    MonthlyBudgetFindByMonthYearHandler,
